    ...
    return (
        <main>
            ...
            <Section bgColor={theme.palette.secondary}>
                ...
                <Typography variant="body1">
                    Spectators have often been known to playfully throw flour and eggs at raft participants in the past.
                    While this appears to be great fun, it&apos;s important to note that plastic bags can be harmful to
                    the watercourse and eggs pose risks to our participants. Both the environment agency and council are
